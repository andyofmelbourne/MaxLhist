...
\therefore d_0 \frac{\sum_{j=0} h^m_{j+\mu_m}}{h^m_{0+\mu_m}}  &=1 - \frac{n^m}{(1-n^m)}\left(\frac{\sum_{j=1} h^m_{j+\mu_m} }{ h^m_{0+\mu_m}} s_0 - (1-s_0)\right) \\
\therefore d_0 \frac{\sum_{j=0} h^m_{j+\mu_m}}{h^m_{0+\mu_m}}  &=1 - \frac{n^m}{(1-n^m)}\left(\left[ \frac{\sum_{j=1} h^m_{j+\mu_m} }{ h^m_{0+\mu_m}} + 1\right]s_0 - 1\right) \\
\therefore d_0 \frac{\sum_{j=0} h^m_{j+\mu_m}}{h^m_{0+\mu_m}}  &=1 - \frac{n^m}{(1-n^m)}\left(\frac{\sum_{j=0} h^m_{j+\mu_m} }{ h^m_{0+\mu_m}}s_0 - 1\right) \\
\therefore d_0  &=\frac{1}{(1-n^m)} \frac{h^m_{0+\mu_m}}{\sum_{j=0} h^m_{j+\mu_m}} - \frac{n^m}{(1-n^m)}s_0
\end{align}
Wow, ok, so now we know $f^m_0$:
\begin{align}
   f^m_0 &= (1-n^m)d_0 + n^m s_0 \\
         &= (1-n^m)\left[ \frac{1}{(1-n^m)} \frac{h^m_{0+\mu_m}}{\sum_{j=0} h^m_{j+\mu_m}} - \frac{n^m}{(1-n^m)}s_0\right] + n^m s_0 \\
         &= \left[\frac{h^m_{0+\mu_m}}{\sum_{j=0} h^m_{j+\mu_m}} - n^m s_0\right] + n^m s_0 \\
         &= \frac{h^m_{0+\mu_m}}{\sum_{j=0} h^m_{j+\mu_m}} 
\end{align}
But I guess we already knew that. 
Moving on:
\begin{align}
   f^m_j &= h^m_{j+\mu_m} \frac{f^m_0}{ h^m_{0+\mu_m}} \\
   &= h^m_{j+\mu_m} \frac{1}{ h^m_{0+\mu_m}} \frac{h^m_{0+\mu_m}}{\sum_{j=0} h^m_{j+\mu_m}} \\
   &= \frac{h^m_{j+\mu_m}}{\sum_{j=0} h^m_{j+\mu_m}}
\end{align}
and...
\begin{align}
   d^m_j &= \frac{1}{(1-n^m)}\left(h^m_{j+\mu_m} \frac{1}{ h^m_{0+\mu_m}}\frac{h^m_{0+\mu_m}}{\sum_{j=0} h^m_{j+\mu_m}}  - n^m s_j\right) \\
   &= \frac{1}{(1-n^m)}\left(\frac{h^m_{j+\mu_m}}{\sum_{j=0} h^m_{j+\mu_m}}  - n^m s_j\right)
\end{align}
I suspect that the global solution is:
\begin{align}
   d_j &= \frac{\sum_m d^m_j}{\sum_m \sum_j d^m_j}
\end{align}
